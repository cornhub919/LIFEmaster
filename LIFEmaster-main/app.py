...
def register():
    try:
        ...
        default_income_categories = [
            ...
            AccountingCategory(name="投资", type="income", color="#CDDC39", is_default=True, user_id=new_user.id),
            AccountingCategory(name="其他收入", type="income", color="#9C27B0", is_default=True, user_id=new_user.id)
        ]
        ...
        default_expense_categories = [
            ...
            AccountingCategory(name="购物", type="expense", color="#FFC107", is_default=True, user_id=new_user.id),
            AccountingCategory(name="住房", type="expense", color="#FF5722", is_default=True, user_id=new_user.id),
            AccountingCategory(name="娱乐", type="expense", color="#F44336", is_default=True, user_id=new_user.id),
            AccountingCategory(name="医疗", type="expense", color="#E91E63", is_default=True, user_id=new_user.id),
            AccountingCategory(name="教育", type="expense", color="#673AB7", is_default=True, user_id=new_user.id),
            AccountingCategory(name="其他支出", type="expense", color="#607D8B", is_default=True, user_id=new_user.id)
        ]
...
def get_categories():
    try:
        ...
        categories = AccountingCategory.query.filter_by(user_id=current_user_id).all()
